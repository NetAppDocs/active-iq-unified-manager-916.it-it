...
. Nella pagina Impostazione avvisi, fare clic su *Aggiungi*.
...
+
.. Immettere *abc* nel campo *Il nome contiene* per visualizzare i volumi il cui nome contiene "`abc`".
.. Seleziona *+<<All Volumes whose name contains 'abc'>> +* dall'area Risorse disponibili e spostarlo nell'area Risorse selezionate.
.. Fare clic su *Escludi* e immettere *xyz* nel campo *Il nome contiene*, quindi fare clic su *Aggiungi*.
