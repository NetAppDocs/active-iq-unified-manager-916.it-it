...
.. Nel campo Il nome dell'evento contiene, immettere `*latency*` e poi clicca sulla freccia per selezionare tutti gli eventi corrispondenti.
.. Nel campo Il nome dell'evento contiene, immettere `*iops*` e poi clicca sulla freccia per selezionare tutti gli eventi corrispondenti.
.. Nel campo Il nome dell'evento contiene, immettere `*mbps*` e poi clicca sulla freccia per selezionare tutti gli eventi corrispondenti.
...
. Configurare qualsiasi altra opzione in questa pagina per l'emissione di tap SNMP e l'esecuzione di uno script.
. Fare clic su *Salva*.
