...
summary: 'L"API REST Active IQ Unified Manager è accessibile tramite qualsiasi browser Web o piattaforma di programmazione in grado di inviare richieste HTTP.  Unified Manager supporta il meccanismo di autenticazione HTTP di base.  Prima di chiamare l"API REST di Unified Manager, è necessario autenticare un utente.' 
---
