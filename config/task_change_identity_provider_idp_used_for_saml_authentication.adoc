...
. Immettere il nuovo URI IdP e i metadati IdP necessari per connettere il server Unified Manager all'IdP.
+
...
. Copiare l'URI dei metadati di Unified Manager oppure salvare i metadati in un file di testo XML.
