...
summary: 'È possibile analizzare gli eventi di prestazioni per identificare quando sono stati rilevati, se sono attivi (nuovi o riconosciuti) o obsoleti, i carichi di lavoro e i componenti del cluster coinvolti e le opzioni per risolvere autonomamente gli eventi.' 
---
