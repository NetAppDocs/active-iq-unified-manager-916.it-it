...
summary: 'Dopo aver configurato le impostazioni di autenticazione remota, è possibile abilitare l"autenticazione SAML (Security Assertion Markup Language) in modo che gli utenti remoti vengano autenticati da un provider di identità sicuro (IdP) prima di poter accedere all"interfaccia utente Web di Unified Manager.' 
---
