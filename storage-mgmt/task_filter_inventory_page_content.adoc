...
summary: 'È possibile filtrare i dati della pagina dell"inventario in Unified Manager per individuare rapidamente i dati in base a criteri specifici.  È possibile utilizzare i filtri per restringere il contenuto delle pagine di Unified Manager in modo da visualizzare solo i risultati di proprio interesse.  Questo fornisce un metodo molto efficiente per visualizzare solo i dati che ti interessano.' 
---
...
image::../media/opm_filtering_panel_draft_3.gif[Uno screenshot dell'interfaccia utente che mostra il pannello di filtraggio con tre filtri.]
