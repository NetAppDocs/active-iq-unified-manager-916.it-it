...
.Passi
. Fare clic sulla parte superiore di una colonna per ordinare i risultati in modo che le informazioni più importanti vengano visualizzate nella parte superiore della vista.
