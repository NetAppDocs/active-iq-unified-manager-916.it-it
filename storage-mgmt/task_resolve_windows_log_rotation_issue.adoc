...
---
= Problema di rotazione dei log di NetApp Manageability SDK sui sistemi Windows
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Quando si installa Unified Manager su Windows, installare Logrotate versione 0.0.0.18.  Per maggiori informazioni, vedere illink:https://www.netapp.com/pdf.html?item=/media/78941-tr-4945.pdf["Guida al rafforzamento della sicurezza per il report tecnico di NetApp Manageability SDK"^] .
