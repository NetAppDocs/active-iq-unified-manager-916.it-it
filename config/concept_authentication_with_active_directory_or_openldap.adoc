...
summary: 'È possibile abilitare l"autenticazione remota sul server di gestione e configurare il server di gestione per comunicare con i server di autenticazione in modo che gli utenti all"interno dei server di autenticazione possano accedere a Unified Manager.' 
---
